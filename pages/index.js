...
let minCountMember = Math.round(memberCarousel.clientWidth / (memberItem.clientWidth + 20));
...
document.addEventListener("DOMContentLoaded", () => {
    countSliderMembers.innerHTML = countMember = Math.round(memberCarousel.clientWidth / (memberItem.clientWidth + 20))
})
